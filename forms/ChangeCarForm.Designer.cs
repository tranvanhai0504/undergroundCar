namespace CarApp.forms
{
    partial class ChangeCarForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            label2 = new Label();
            txt_brand = new Guna.UI2.WinForms.Guna2TextBox();
            label3 = new Label();
            label4 = new Label();
            label5 = new Label();
            guna2ComboBox = new Guna.UI2.WinForms.Guna2ComboBox();
            flowLayoutPanel_fuel = new FlowLayoutPanel();
            guna2Button1 = new Guna.UI2.WinForms.Guna2Button();
            txt_price = new Guna.UI2.WinForms.Guna2NumericUpDown();
            ...
            // txt_brand
            // 
            txt_brand.BorderRadius = 10;
            txt_brand.CustomizableEdges = customizableEdges3;
            txt_brand.DefaultText = "";
            txt_brand.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
            txt_brand.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
            txt_brand.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
            txt_brand.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
            txt_brand.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
            ...
            guna2ComboBox.BorderRadius = 10;
            guna2ComboBox.CustomizableEdges = customizableEdges5;
            ...
            Controls.Add(flowLayoutPanel_fuel);
            Controls.Add(guna2ComboBox);
            Controls.Add(label5);
            Controls.Add(label4);
            Controls.Add(label3);
            Controls.Add(label2);
        ...
        private FlowLayoutPanel flowLayoutPanel_fuel;
